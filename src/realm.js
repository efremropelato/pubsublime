...
export const isDataFit = (when, data) => {
  return compareData(when, getValue(data))
}

export const makeDataSerializable = (body) => {
  return (body && ('payload' in body) ? { p64: body.payload.toString('base64') } : body)
}

export const unSerializeData = (body) => {
